...
export const CompanyMetricContext = React.createContext<
  CompanyMetricsContextProps
>({
  companyEvaluation: 0,
      ...
      <div className={"container"}>
        <div className={"headerMenu"}>
          ...
          <div className={"companyMetrics"}>
            <div className={"companyEvaluation"}>
              Company valuation: {companyEvaluation} NOK
            </div>
            <div className={"companySuccessRate"}>
              Your chance of success: {chanceOfSuccess} %
            </div>
          </div>
          <br />
